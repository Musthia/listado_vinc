...
class Frame(tk.Frame):
    ...
    def campos_Catastro_database(self):
        ...
        self.label_zona = tk.Label(self, text = "CUIL/CUIT")
        ...
        self.boton_pegar.grid(row = 2, column = 2)  # Puedes ajustar la posición según el diseño
    ...
    def tabla_Catastro_database(self):
        ...
        self.tabla = ttk.Treeview(self, column = ("DENOMINACION", "CUIL/CUIT", "LOTE", "CAJA", "REGISTRO",))
        ...
        self.tabla.heading("#2", text = "CUIL/CUIT",)
    ...
    def mostrar_resultados(self, rows):
        ...
        treeview_resultados["columns"] = ("ID", "DENOMINACION", "CUIL/CUIT", "LOTE", "CAJA", "REGISTRO")
        ...
        treeview_resultados.column("CUIL/CUIT", anchor=tk.CENTER, width=75
        )
        ...
        treeview_resultados.heading("CUIL/CUIT", text="CUIL/CUIT", anchor=tk.CENTER)
    ...
    """ def editar_datos(self):
        try:
           self.id_Catastro_database = self.tabla.item(self.tabla.selection())["text"]
           self.denominacion_Catastro_database = self.tabla.item(
            self.tabla.selection())["values"][0]
           self.zona_Catastro_database = self.tabla.item(
            self.tabla.selection())["values"][1]
           self.caja_Catastro_database = self.tabla.item(
            self.tabla.selection())["values"][2]
           self.registro_Catastro_database = self.tabla.item(
...
class FiltroFechaVentana(tk.Toplevel):
    def __init__(self, master=None):
        ...
        # Crear un Treeview para mostrar los resultados
        self.treeview_resultados = ttk.Treeview(self, columns=("ID", "Denominacion", "CUIL/CUIT", "LOTE", "Registro"))
        ...
        self.treeview_resultados.heading("#2", text="CUIL/CUIT")
        ...
        self.treeview_resultados["columns"] = ("ID", "Denominación",  "CUIL/CUIT", "LOTE", "Caja", "Registro")
        ...
        self.treeview_resultados.heading("CUIL/CUIT", text="CUIL/CUIT")
        self.treeview_resultados.column("CUIL/CUIT", width=75)
